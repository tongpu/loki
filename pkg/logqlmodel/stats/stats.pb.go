...
type Summary struct {
	...
	// Total unique bytes processed.
	TotalDuplicatedBytesProcessed int64 `protobuf:"varint,11,opt,name=totalDuplicatedBytesProcessed,proto3" json:"totalDuplicatedBytesProcessed"`
	// Total unique bytes processed.
	TotalDeduplicatedBytesProcessed int64 `protobuf:"varint,12,opt,name=totalDeduplicatedBytesProcessed,proto3" json:"totalDeduplicatedBytesProcessed"`
}
...
func (m *Summary) GetTotalDuplicatedBytesProcessed() int64 {
	if m != nil {
		return m.TotalDuplicatedBytesProcessed
	}
	return 0
}

func (m *Summary) GetTotalDeduplicatedBytesProcessed() int64 {
	if m != nil {
		return m.TotalDeduplicatedBytesProcessed
	}
	return 0
}
...
var fileDescriptor_6cdfe5d2aea33ebb = []byte{
	...
	,
}
...
func (this *Summary) Equal(that interface{}) bool {
	...
	if this.TotalDuplicatedBytesProcessed != that1.TotalDuplicatedBytesProcessed {
		return false
	}
	if this.TotalDeduplicatedBytesProcessed != that1.TotalDeduplicatedBytesProcessed {
		return false
	}
	return true
}
...
func (this *Summary) GoString() string {
	...
	s = append(s, "TotalDuplicatedBytesProcessed: "+fmt.Sprintf("%#v", this.TotalDuplicatedBytesProcessed)+",\n")
	s = append(s, "TotalDeduplicatedBytesProcessed: "+fmt.Sprintf("%#v", this.TotalDeduplicatedBytesProcessed)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Summary) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TotalDeduplicatedBytesProcessed != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.TotalDeduplicatedBytesProcessed))
		i--
		dAtA[i] = 0x60
	}
	if m.TotalDuplicatedBytesProcessed != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.TotalDuplicatedBytesProcessed))
		i--
		dAtA[i] = 0x58
	}
	if m.Shards != 0 {
...
func (m *Summary) Size() (n int) {
	...
	if m.TotalDuplicatedBytesProcessed != 0 {
		n += 1 + sovStats(uint64(m.TotalDuplicatedBytesProcessed))
	}
	if m.TotalDeduplicatedBytesProcessed != 0 {
		n += 1 + sovStats(uint64(m.TotalDeduplicatedBytesProcessed))
	}
	return n
}
...
func (this *Summary) String() string {
	...
	s := strings.Join([]string{`&Summary{`,
		...
		`TotalDuplicatedBytesProcessed:` + fmt.Sprintf("%v", this.TotalDuplicatedBytesProcessed) + `,`,
		`TotalDeduplicatedBytesProcessed:` + fmt.Sprintf("%v", this.TotalDeduplicatedBytesProcessed) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Summary) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalDuplicatedBytesProcessed", wireType)
			}
			m.TotalDuplicatedBytesProcessed = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalDuplicatedBytesProcessed |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalDeduplicatedBytesProcessed", wireType)
			}
			m.TotalDeduplicatedBytesProcessed = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalDeduplicatedBytesProcessed |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
